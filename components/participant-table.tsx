    ...
    return (
      <div className="space-y-4">
        ...
        <div className="overflow-hidden rounded-lg border border-border">
          <div className="h-12 animate-pulse bg-secondary/50" />
          {[...Array(5)].map((_, i) => (
                          ...
                          {participant.paymentStatus !== 'paid' && participant.status !== 'cancelled' && (
                            <>
                              <DropdownMenuItem
                                ...
                                onClick={() => {
                                  // updateParticipant → sendNotification() in store.ts sends seat_confirmed
                                  // email automatically with login credentials included
